...
def error_message_detail(error, error_detail: sys):
    """
    This function takes an error and its details and returns a formatted string with the error message and details.
    """
...
class CustomException(Exception):
    ...
    It takes an error and its details and returns a formatted error message.
    """
